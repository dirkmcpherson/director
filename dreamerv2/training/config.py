...
class MinAtarConfig():
    ...
    #HRL
    logits_size: int = 8
    goal_encoder: Dict = field(default_factory=lambda:{'layers':3, 'node_size':200, 'dist':"onehotst", 'activation':nn.ELU, 'depth':16, 'class_size':8, 'category_size':8}) # dist is onehot in original code
    goal_decoder: Dict = field(default_factory=lambda:{'layers':3, 'node_size':200, 'dist':None, 'activation':nn.ELU, 'depth':16, 'class_size':8, 'category_size':8}) # Dist is MSE in original code
